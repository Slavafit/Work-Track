                ...
                Card(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(8.dp)) {
                    Column(Modifier.fillMaxWidth().padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            ...
                            OutlinedButton(
                                onClick = { vm.shareObjectReport(objectId, { context.sharePdfReport(it) }, { context.shareText(it) }) },
                                modifier = Modifier.weight(1f)
                            ) {
        ...
        Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
            when (tab) {
                ...
                2 -> {
                    ...
                    Button(onClick = { vm.shareObjectReport(objectId, { context.sharePdfReport(it) }, { context.shareText(it) }) }, enabled = objectId != 0L, modifier = Modifier.fillMaxWidth()) {
                        Icon(Icons.Outlined.Share, null)
                        Spacer(Modifier.width(8.dp))
                        Text(stringResource(R.string.action_share_report))
                    }
